...
import { DataTableType, DescendingComparatorInterface, GetComparatorOrderType, StabilizedSortType, TableOptionsInterface } from '../../interfaces'
...
export function getComparator<T>(order: GetComparatorOrderType, orderBy: string): getComparatorReturn<T> {
    if (order === 'desc') {
        return (a: T, b: T) => descendingComparator({ a: a as Record<any, any>, b: b as Record<any, any>, orderBy })
    }
    return (a: T, b: T) => -descendingComparator({ a: a as Record<any, any>, b: b as Record<any, any>, orderBy })
}
